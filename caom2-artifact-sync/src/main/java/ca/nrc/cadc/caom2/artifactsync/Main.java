...
public class Main {
	...
	public static void main(String[] args) {
		try {
			...
			PrivilegedExceptionAction<Integer> harvester = new ArtifactHarvester(artifactDAO, dbInfo, artifactStore,
					collection, dryrun, batchSize, noVolumeLimitation);

			PrivilegedExceptionAction<Object> downloader = new DownloadArtifactFiles(artifactDAO, dbInfo, artifactStore,
					nthreads, batchSize);
